<?php if (comments_open()) : ?>
    ...
    <!-- Kommentar eingeben -->
            ...
            <h3><?php _e('Write Comment.', 'wabc'); ?> <small class="text-danger"><?php _e('*Mandatory', 'wabc'); ?></small></h3>
            ...
            <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" role="form">
                ...
                <div class="form-group  text-center">
                    <input class="form-control btn btn-primary" name="submit" type="submit" id="submit" tabindex="5" value="<?php _e('Send comment.', 'wabc'); ?>" />
