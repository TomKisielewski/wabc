...
/*function new_excerpt_more( $more ) {
	return ' <p><a class="read-more btn btn-default" href="'. get_permalink( get_the_ID() ) . '">' . __('Read More', 'wabc') . '</a></p>';
}
...
function all_excerpts_get_more_link($post_excerpt) {
    ...
    return $post_excerpt . ' [...]<p><a class="btn btn-default wabc-read-more-link" href="'. get_permalink( get_the_ID()) . '">' . 'Read More...' . '</a></p>';
}
